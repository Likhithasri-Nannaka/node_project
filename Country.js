...
let Country = class Country {
    constructor(name, country_code_two, country_code_three, mobile_code, continent_id) {
        this.name = name;
        this.country_code_two = country_code_two;
        this.country_code_three = country_code_three;
